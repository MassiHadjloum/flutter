  ...
  prepareListDikr(String mode) {
    switch (mode) {
      case "أذكار الصباح":
        ...
        _messages = [...Data.msgNinaSabah];
        break;
      case "أذكار المساء":
        _adkar = [...Data.adkarmassa];
        _messages = [...Data.msgNinaMassa];
        break;
      case "أذكار الإستيقاظ":
        _adkar = [...Data.adkaristiqadh];
        _messages = [...Data.msgNinaIstiqadh];
        break;
      case "أذكار النوم":
        _adkar = [...Data.adkarnawm];
        _messages = [...Data.msgNinaNawm];
        break;
      case "أذكار بعد الصلاة":
        _adkar = [...Data.adkarsalat];
        _messages = [...Data.msgNinaAfterSalat];
        break;
      case "أذكار الآذان":
  ...
  Future<bool?> _buildDialogConfirmation(
    ...
    return showDialog<bool>(
      ...
      builder: (ctx) => MyAlertDialogue(
        ctx: ctx,
        textDialogue: "Banana, ur3ad tselkedh !\nTu veux quiter a tabanant ?",
        textColor: textColor,
